...
1-4. それ以外の機能は？
 ...
 　詳細は配布ファイルに同梱の<d.hatena.mac.txt>をご覧ください。
...
4. 必要なもの
 ...
 ・秀丸エディッタ同梱DLL・COM・cmd.exe・csc.exe(.NET Framework)の 読み出し・実行ができ、編集中のファイル・はてなダイアリの読み出し・書き込みができ、本マクロのあるフォルダとその配下のフォルダにてファイルを作成・実行・書き込みできる 環境。
